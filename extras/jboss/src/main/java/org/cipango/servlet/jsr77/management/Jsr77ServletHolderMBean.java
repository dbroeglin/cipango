...
package org.cipango.servlet.jsr77.management;
...
import org.cipango.servlet.jsr77.Jsr77ServletHolder;
 ...
 *
 * @author janb
 * @version $Revision: 1259 $ $Date: 2006-11-19 17:00:48 +0100 (dim., 19 nov. 2006) $
 *
 */
public class Jsr77ServletHolderMBean extends ObjectMBean
{
   ...
   public ObjectName getObjectName()
   {
       ...
       try
       {
           oname = new ObjectName(getMBeanContainer().getDomain()+":J2EEServer=none,J2EEApplication=none,J2EEWebModule="+((JBossSipAppContext)_servletHolder.getWebAppContext()).getUniqueName()+",j2eeType=Servlet,name="+name);    
       }
       catch (Exception e)
       {
           Log.warn(e);
