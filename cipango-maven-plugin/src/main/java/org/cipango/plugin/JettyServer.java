//========================================================================
//$Id: JettyServer.java 6011 2010-05-14 17:58:09Z joakime $
 ...
 * 
 */
public class JettyServer extends org.cipango.server.Server
{
    ...
    {
        PluginLog.getLog().info("Starting Cipango "+getClass().getSuperclass().getPackage().getImplementationVersion()+" ...");
        super.doStart();
    }
