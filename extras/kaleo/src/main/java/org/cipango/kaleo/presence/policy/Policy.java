...
public class Policy
{
	...
	private static final Logger __log = LoggerFactory.getLogger(Policy.class);
	...
	public Policy(Resource resource, XcapService xcapService)
	{
	...
	class XcapListenerImpl implements XcapListener
	{
		...
		public void documentChanged(XcapResource resource)
		{
			...
			for (int i = 0; i < LazyList.size(_listeners); i++)
				((PolicyListener) LazyList.get(_listeners, i)).policyHasChanged(Policy.this);
		}
