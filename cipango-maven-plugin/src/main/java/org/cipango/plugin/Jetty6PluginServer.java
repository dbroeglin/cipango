...
import org.eclipse.jetty.plugin.util.PluginLog;
...
/**
 * Jetty6PluginServer
 * Copy of org.mortbay.jetty.plugin.Jetty6PluginServer using org.cipango.Server.
...
public class Jetty6PluginServer implements JettyPluginServer
{
    ...
    protected ContextHandlerCollection contexts; //the list of ContextHandlers
